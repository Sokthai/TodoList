        ...
        <table class="table table-bordered table-striped">
            ...
            <?php $__currentLoopData = $todos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="success">
                    ...
                    <td>
                        <span><h3><a href="/<?php echo e($todo->name); ?>" class="blog-post-title <?php echo e($todo->closing == 1? "statusComplete" : "statusInComplete"); ?>"><?php echo e(title_case($todo->name)); ?></a>
                            <b style="font-size: 50%; color: gray">Last Edit: <?php echo e($todo->description->last()->created_at->diffForHumans(null, true)); ?></b>
                                <?php echo e(($todo->favorite === 1)? " &#11088;" : ""); ?></h3></span>
                        <h6 class="blog-post-meta">
                            &nbsp;	<span style="color: #8a6d3b"><?php echo e(ucfirst($todo->type)); ?></span>
                            : created <?php echo e($todo->created_at->diffForHumans(null)); ?>
